define(function () {var THIS_UNIT = function(){
	...
	this.prop("primary.end", 14);
	this.prop("primary.str", 14);
	this.prop("primary.vit", 10);
	
	this.prop("gear.head", {name:"unarmored", def:750, poise:25, weight:4});
	this.prop("gear.torso", {name:"unarmored", def:750, poise:25, weight:4});
	this.prop("gear.arms", {name:"unarmored", def:750, poise:25, weight:4});
	this.prop("gear.legs", {name:"unarmored", def:750, poise:25, weight:4});
	this.prop("gear.weapon", {name:"basic_sword", atk:50, bns:5, cost:10, force:200, weight:5});
